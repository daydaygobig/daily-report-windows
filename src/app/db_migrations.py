...
def ensure_schema(engine: Engine) -> None:
    ...
    _ensure_column(engine, "tasks", "upstream_task_id", "INTEGER")
    _ensure_column(engine, "tasks", "card_input_source", "TEXT NOT NULL DEFAULT 'chatlog'")
    _ensure_column(engine, "tasks", "image_model_sequence", "TEXT")
    ...
    _ensure_column(engine, "jobs", "max_image_count", "INTEGER NOT NULL DEFAULT 12")
